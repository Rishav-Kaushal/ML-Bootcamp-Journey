...
#Tuple methods
print(num.count( 1 )) #cont no of times 1 present .
print(num.index( 3 )) # find which idx(first) has 3 present.
...
first, *middle, last = num2 #unpacking with *(asterisk)
print( first )
...
##Sets In Python----------------------------------------- 
#unordered collections, mutable
my_set = {1,2,3,4,5}
print(my_set)
print(type(my_set))
empty_set = set()   # empty={} this is a empty dict not a set
